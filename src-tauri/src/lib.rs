...
pub fn run() {
    ...
    builder
        ...
        }, Migration { version: 2, description: "atomic reading sync outbox", sql: migrations::sync_sql(), kind: MigrationKind::Up }, Migration { version: 3, description: "account folder catalogs", sql: migrations::folder_catalog_sql(), kind: MigrationKind::Up }]).build())
