...
- EPUB rendering uses [foliate-js](https://github.com/johnfactotum/foliate-js), copyright John Factotum and contributors, MIT licensed. Quire applies a guarded build-time modification to its paginator to provide bounded loading and recover failed page turns; EPUB scripting is prohibited by sanitization and a restrictive document CSP; dependency upgrades must review this modification.
